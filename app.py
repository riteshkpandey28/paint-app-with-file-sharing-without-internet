...
def upload_image1():
    if request.method == 'POST':
        ...
        imagel = Image.new('RGB', (1280, 720), "white")
        image2 = Image.open('./static/uploads/fish1.png')
        basewidth = 735
        ...
        imagel.paste(image2, (270, 150))
        imagel = imagel.save("./static/uploads/fish1.png")
...
def upload_image2():
    if request.method == 'POST':
        ...
        imagel = Image.new('RGB', (1280, 720), "white")
        image2 = Image.open('./static/uploads/fish2.png')
        basewidth = 735
        wpercent = (basewidth / float(image2.size[0]))
        hsize = int((float(image2.size[1]) * float(wpercent)))
        image2 = image2.resize((basewidth, hsize), Image.ANTIALIAS)
        imagel.paste(image2, (270, 150))
        imagel = imagel.save("./static/uploads/fish2.png")
        flash('Image successfully uploaded')
        return redirect(url_for('home'))
